...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/poppup.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
class Modal extends React.Component {
    ...
    componentDidMount() {
        ...
        this.storage.onChange((e) => {
            var _a, _b;
            if (typeof ((_a = e["blocker_counter"]) === null || _a === void 0 ? void 0 : _a.newValue) === "number") {
                this.setState({ counter: e["blocker_counter"].newValue });
            }
            if (((_b = e['blocker_keyword_list']) === null || _b === void 0 ? void 0 : _b.newValue) instanceof Array) {
    ...
    render() {
        return React.createElement("div", { className: "card" },
            React.createElement("div", { className: "body" },
                React.createElement("div", { className: "label blocked-counter" },
                    "\u0417\u0430\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u043E: ",
                    React.createElement("b", null, this.state.counter)),
                React.createElement("div", { className: "label" }, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043B\u044E\u0447\u0435\u0432\u043E\u0435 \u0441\u043B\u043E\u0432\u043E"),
                React.createElement("input", { value: this.state.inputValue, onChange: ({ currentTarget }) => { this.setState({ inputValue: currentTarget.value }); }, type: "text", className: "key-word-field" }),
                React.createElement("button", { onClick: () => this.storage.addKeyWord(this.state.inputValue), className: "btn key-word-add" }, "\u0412\u043D\u0435\u0441\u0442\u0438"),
...
const Modal_1 = __webpack_require__(/*! ./Modal */ "./src/Modal.tsx");
const root = document.querySelector("#root");
if (!root) {
    throw new Error("Root not found");
}
ReactDOM.render(React.createElement(Modal_1.Modal, null), root);


/***/ })

/******/ });
//# sourceMappingURL=poppup.js.map